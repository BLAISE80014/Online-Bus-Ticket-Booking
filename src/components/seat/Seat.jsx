...
function Seat({ seatNumber, isSelected, onClick }) {
    return (
        <MdOutlineChair
...
return (
    <div className='space-y-5'>
        ...
        {/* Placeholder for Instructions / Selected seats */}
            ...
            <div className='!mt-10'>
                ...
                <div className='flex flex-wrap'>
                    {selectedSeats.map(seat => (
                        <div className='w-10 h-10 rounded-md m-1.5 text-lg font-medium bg-viole-600/30 flex items-center justify-center'>
                            {seat}
                        </div>
                    ))}
                </div>
